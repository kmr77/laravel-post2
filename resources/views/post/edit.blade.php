        ...
        <div class="mx-4 sm:p-8">
            <form method="post" action="{{route('post.update', $post)}}" enctype="multipart/form-data">
                ...
                <div class="md:flex items-center mt-8">
                    ...
                    <input type="text" value="{{old('title', $post->title)}}" name="title" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="title" placeholder="Enter Title">
                    </div>
                </div>
